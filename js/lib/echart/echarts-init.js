$(document).ready(function() {
    ...
    option = {
        ...
        legend: {
            data:['Cabin Pressure','EPR','Fuel Manifold Pressure']
        },
    ...
    option = {
        ...
        legend: {
            orient : 'vertical',
            x : 'left',
            data:['GPS Accuracy','Autopilot Reliability','Waypoint Tracking','Route Optimization','Communication Systems']
        },
        calculable : true,
        series : [
            {
                ...
                center: ['50%', '60%'],
                data:[
                    {value:335, name:'GPS Accuracy'},
                    {value:310, name:'Autopilot Reliability'},
                    {value:234, name:'Waypoint Tracking'},
                    {value:135, name:'Route Optimization'},
                    {value:1548, name:'Communication Systems'}
                ]
            }
        ]
    };
    ...
    option = {
        ...
        legend: {
            orient : 'vertical',
            x : 'left',
            data:['Avionics System ','Hydraulic System','Pneumatic System','Flight Control System','Environmental Control System','Fuel System','Electrical System','Landing Gear System','Engine Health','Other']
        },
        calculable : false,
        series : [
            {
                ...
                data:[
                    {value:335, name:'Avionics System'},
                    {value:679, name:'Hydraulic System'},
                    {value:1548, name:'Pneumatic System', selected:true}
                ]
            },
            {
                name:'Source',
                ...
                data:[
                    {value:335, name:'Avionics System'},
                    {value:310, name:'Flight Control System'},
                    {value:234, name:'Environmental Control System'},
                    {value:135, name:'Fuel System'},
                    {value:1048, name:'Electrical System'},
                    {value:251, name:'Landing Gear System'},
                    {value:147, name:'Engine Health'},
    ...
    option = {
        ...
        legend: {
            orient : 'vertical',
            x : 'left',
            data:['Altitude Precision','Heading Accuracy','ILS Performance','ILS Performance','Pneumatic System']
        },
        calculable : true,
        series : [
            {
                ...
                radius : ['50%', '70%'],
                data:[
                    {value:335, name:'Altitude Precision'},
                    {value:310, name:'Heading Accuracy'},
                    {value:234, name:'VOR/DME Reliability'},
                    {value:135, name:'ILS Performance'},
                    {value:1548, name:'Pneumatic System'}
                ]
            }
        ]
    };
    ...
    option = {
        ...
        polar : [
            {
                indicator : [
                    { text: 'Avionics Performance', max: 6000},
                    { text: 'Fuel Efficiency', max: 16000},
                    { text: 'Fuel Efficiency', max: 30000},
                    { text: 'Navigation Accuracy', max: 38000},
                    { text: 'Structural Integrity', max: 52000},
                    { text: 'Flight Control Responsiveness', max: 25000}
                ]
            }
        ],
        calculable : true,
